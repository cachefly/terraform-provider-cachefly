---
page_title: "Comprehensive Setup Guide"
---
...
2. Edit variables: `var.domain`, `var.unique_suffix`, `var.admin_username`, `var.support_username`.
...
variable "unique_suffix" {
  ...
  type        = string
  default     = "v17"  # Change this for each deployment (v1, v2, v3, etc.)
}
...
resource "cachefly_service" "website" {
  ...
  options = {
    ...
    # ttfb_timeout = {
    #   enabled = true
    #   value   = 3                # Time to first byte timeout
    # }
...
resource "cachefly_service" "api" {
  ...
  options = {
    ...
    ttfb_timeout = {
      enabled = true
      value   = 3              # Shorter timeout for APIs
    }
...
resource "cachefly_script_config" "url_redirects" {
  ...
  script_config_definition = "63528a94fbe03a0043d0b86d"  # URL redirects script
  mime_type               = "text/json"
  activated               = true
...
resource "cachefly_script_config" "aws_credentials" {
  ...
  script_config_definition = "633ee8df2eeef2003e34acdd"  # AWS credentials script
  mime_type               = "text/json"
  activated               = true
